...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 3ef5e6d

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 590f748
* **deps:** update dependency opentofu to v1.12.2 11aac40
* **deps:** update dependency opentofu to v1.12.3 66d5d2d
* **deps:** update dependency opentofu to v1.12.4 7bab094
* **deps:** update dependency tflint to v0.63.1 9a92f8e
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 7e36532
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 28f6417

## 8.2.2 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 3abf408

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu d47f8f7
* **deps:** update dependency opentofu to v1.11.7 98bc67d
* **deps:** update dependency opentofu to v1.12.0 1b12b7a
* **deps:** update dependency terraform-docs to v0.23.0 738d1ad
* **deps:** update dependency terraform-docs to v0.24.0 4f13284
* **deps:** update dependency tflint to v0.62.1 a257a32
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 d7e8b61
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 7032877
* **deps:** update tools e852249
* **pre-commit:** 🔧 move to prek 512f69e
* **tfdocs:** bump tfdocs to v0.22 🔧 5df3c4e

## 8.2.1 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 35733f5

### Code Refactoring

* update module structure and Github actions 👷 b1065d4

### Miscellaneous Chores

* **deps:** update dependency trivy to v0.69.3 a4d73c5
